    ...
    <div className="min-h-screen bg-background text-foreground font-mono relative">
      ...
      <header className="fixed top-0 left-0 right-0 border-b border-white/20 bg-background/95 backdrop-blur z-40 px-4 py-3 sm:px-6 sm:py-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col justify-between md:flex-row md:items-center md:justify-between gap-1 sm:gap-4 min-h-[85px] md:min-h-0">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="relative pl-5 pb-4 border-b border-white/10 last:border-0 last:pb-0">
                    ...
                    <p className="text-accent text-sm sm:text-base mt-1">{job.company} <span className="text-gray-500">|</span> {job.period}</p>
            ...
            <div className="card animate-fade-in-delay-2 opacity-0">
              ...
              <div className="space-y-5">
                <div className="relative pl-5 pb-4 border-b border-white/10">
                  <div className="absolute left-0 top-1 w-2 h-2 bg-accent rounded-full"></div>
                  <h3 className="text-white font-bold text-sm sm:text-base">COMPUTER SCIENCE</h3>
                  <p className="text-accent text-sm sm:text-base mt-1">Donbas State Engineering Academy</p>
                  <p className="text-gray-500 text-sm sm:text-base">2018 - 2023</p>
                </div>
                
                <div className="relative pl-5">
                  <div className="absolute left-0 top-1 w-2 h-2 bg-white/50 rounded-full"></div>
                  <h3 className="text-white font-bold text-sm sm:text-base">APPLIED MATHEMATICS</h3>
                  <p className="text-accent text-sm sm:text-base mt-1">Horlivka Technical College</p>
                  <p className="text-gray-500 text-sm sm:text-base">2011 - 2014</p>
                </div>
              </div>

              <div className="pt-4 mt-4 border-t border-white/10">
                <button onClick={onDownloadPDF} className="btn btn-primary w-full text-center block text-sm sm:text-base py-2">
